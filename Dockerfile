...
# Add this line to copy the Python script into the container
COPY /generate_unbound_conf.py /usr/local/bin/generate_unbound_conf.py
COPY /blocks.txt /usr/local/bin/blocks.txt
